...
import Analizador3.Generado.Parser;
import Analizador3.Generado.ParseException;
import Analizador3.Generado.TokenMgrError;
...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            Parser parser = new Parser(new BufferedReader(new FileReader(".\\src\\Analizador3\\test.txt")));
            // We analyze the file
            parser.Verify();
